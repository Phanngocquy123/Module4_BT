package com.ra.springmvc2.repository.impl;

import com.ra.springmvc2.repository.Repository;
import com.ra.springmvc2.util.Column;
import com.ra.springmvc2.util.DbContext;
import com.ra.springmvc2.util.Id;
import com.ra.springmvc2.util.Table;
...
public class RepositoryImpl<T> implements com.ra.springmvc2.repository.Repository<T> {
    @Override
